    ...
    Tables: {
      ...
      documents: {
        Row: {
          ...
          id: string
          /** Foreign key linking to the opportunity this document belongs to */
          opportunity_id: string
          /** Human-readable document name */
          name: string
          /** Public URL where the document is hosted */
          url: string
      ...
      activities: {
        Row: {
          ...
          id: string
          /** Foreign key linking to the opportunity this activity belongs to */
          opportunity_id: string
          /** Type of activity (e.g. note, call, email) */
          type: string
